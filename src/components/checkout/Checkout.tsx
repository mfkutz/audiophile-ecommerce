...
export default function Checkout({ onClose }: checkoutProps) {
    ...
    return (
        ...
        <>
            ...
            <div
                ref={modalRef}
                className="bg-white h-fit rounded-lg py-[60px] px-[30px] w-[374px] z-50">
                    ...
                    <div className="flex justify-between items-center gap-4">
                        ...
                        <div className="flex justify-between w-full ">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="w-[96px] h-[33px] bg-white-ec flex flex-row items-center justify-between px-5">
